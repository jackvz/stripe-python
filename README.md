...
For apps that need to use multiple keys during the lifetime of a process, or
set a specific [Stripe Version](https://stripe.com/docs/api#versioning) it's
also possible to set on each request:
